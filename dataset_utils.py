...
def _load_processed_data(path):
    ...
    # rejects PyG Data objects saved in processed dataset files.
...
def DataLoader(name):
    ...
    if name in ['cora', 'citeseer', 'pubmed']:
        ...
        # Use repo behavior first. If the raw URL is unavailable, fallback to
        # the geom_gcn_preprocess=True graph so the dataset remains loadable.
        try:
